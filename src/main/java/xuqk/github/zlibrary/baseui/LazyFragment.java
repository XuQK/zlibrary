...
public class LazyFragment extends Fragment {
    ...
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup mContainer, @Nullable Bundle savedInstanceState) {
        this.mLayoutInflater = inflater;
        this.mContainer = mContainer;
        onCreateView(savedInstanceState);
        if (mRootView == null) {
            return super.onCreateView(inflater, mContainer, savedInstanceState);
        }
    ...
    private void onCreateView(Bundle savedInstanceState) {
        ...
        if (isLazyEnable) {
            if (isVisible && !isInitReady) {
                ...
                if (mInflater == null && getActivity() != null) {
    ...
    protected void setContentView(int layoutResID) {
        if (isLazyEnable && getRootView() != null && getRootView().getParent() != null) {
            ...
            View view = mLayoutInflater.inflate(layoutResID, layout, false);
            layout.addView(view);
        } else {
